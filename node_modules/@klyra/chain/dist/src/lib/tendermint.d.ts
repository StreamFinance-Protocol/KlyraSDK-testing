...
import { type BroadcastTxAsyncResponse, type BroadcastTxSyncResponse } from "@cosmjs/tendermint-rpc/build/tendermint37";
import { type BroadcastMode, type BroadcastOptions, type TxResponsePromise } from "../types";
export declare class TendermintClient {
     ...
     */
    broadcastTransaction(tx: Uint8Array, mode: BroadcastMode): TxResponsePromise;
    /**
