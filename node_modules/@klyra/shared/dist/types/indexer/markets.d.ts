...
export declare enum IndexerPerpetualMarketStatus {
    ACTIVE = "ACTIVE",
    PAUSED = "PAUSED",
...
export declare enum IndexerPerpetualMarketType {
    CROSS = "CROSS",
    ISOLATED = "ISOLATED"
}
...
export type IndexerMarketBatchUpdateMessage = WebSocketMessage<IndexerMarketBatchUpdateContents>;
export type IndexerMarketSubscribedMessage = WebSocketMessage<IndexerMarketSubscribedContents>;
export {};
