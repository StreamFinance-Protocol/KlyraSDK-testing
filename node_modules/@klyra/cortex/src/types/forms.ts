...
interface InternalTradeState {
  // Internal state not exposed to the store
  price?: number;
  filled?: boolean;
  worstPrice?: number;
}
...
export type TradeFormInputsUnion =
  | MarketTradeInputs
  | LimitTradeInputs
...
export type TradeForm = BaseForm<
  TradeFormInputsUnion,
  TradeFormSummary,
  TradeFormOptions
>;
export type TradeFormInputs = TradeForm["inputs"];
export type TradeFormInputsKeys =
  | keyof MarketTradeInputs
  | keyof LimitTradeInputs
  | keyof StopLimitTradeInputs
  | keyof TakeProfitLimitTradeInputs
  | keyof StopMarketTradeInputs
  | keyof TakeProfitMarketTradeInputs;

type MarketTradeFormInputsUnion =
  | MarketTradeInputs
  | TakeProfitMarketTradeInputs
  | StopMarketTradeInputs;
type LimitTradeFormInputsUnion =
  | LimitTradeInputs
  | StopLimitTradeInputs
  | TakeProfitLimitTradeInputs;

export type MarketTradeForm = BaseForm<
  MarketTradeFormInputsUnion,
  TradeFormSummary,
  TradeFormOptions
>;
export type MarketTradeFormInputs = MarketTradeForm["inputs"];

export type LimitTradeForm = BaseForm<
  LimitTradeFormInputsUnion,
  TradeFormSummary,
  TradeFormOptions
>;
