import { type OrderSide, type OrderStatus, type OrderTimeInForce, type OrderType } from "@klyra/shared";
...
export declare enum FillLiquidity {
    MAKER = "MAKER",
    TAKER = "TAKER"
}
...
declare enum TransferRecordType {
    DEPOSIT = "DEPOSIT",
    WITHDRAW = "WITHDRAW",
